        ...
        <div className={active ? 'menu menuOpen' : 'menu menuClose'}>
          <nav className='list'>
            <ul className='header_ul list_items'>
              <li className='header_li'><a className='header_a a_mobile' href="#aboutMe">SOBRE MIM</a></li>
              <li className='header_li'><a className='header_a a_mobile' href="#projects">PROJETOS</a></li>
              <li className='header_li'><a className='header_a a_mobile' href="#skills">HABILIDADES</a></li>
            </ul>
          </nav>
        </div>
      </div>
